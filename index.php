<html>
 ...
 <style type="text/css">
 	body { border-top: solid 15px #000;background-color: rgb(173, 216, 230));
 	    color: #333;padding: 20; font-size: .85em; position: absolute;margin-top: -100px;;
 	    font-family: "Segoe UI", Verdana, Helvetica, Sans-Serif;
 	}
 	h1, h2, h3,{ color: #000; margin-bottom: 5px align-self: auto;; padding-bottom: 5px align-self: auto;; }
 	h1 { font-size: 2em; grid-gap: 16px; }
 	h2 { font-size: 1.75em; }
 	h3 { font-size: 1.2em; }
